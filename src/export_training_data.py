...
Only the columns the model actually needs (Elo, form, venue, goals) --
this is committed to the repo (unlike the raw Kaggle CSVs or the full
merged results_with_form.csv) so the deployed dashboard can train itself
...
LEAN_COLUMNS = ["date", "home_elo", "away_elo", "neutral", *FORM_COLUMNS, "home_score", "away_score", "tournament"]
